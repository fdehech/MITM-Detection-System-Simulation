...
export function ConfigPanel({ config, onSave, onReset, isSaving, isResetting, showOnly }: ConfigPanelProps) {
  ...
  return (
    <div className="space-y-4">
      {/* Client Config Card */}
      {(!showOnly || showOnly.includes("client")) && (
      ...
      {(!showOnly || showOnly.includes("server")) && (
        <div className="glass-panel rounded-xl p-6">
          <div className="flex items-center gap-3 mb-6">
      ...
      {(!showOnly || showOnly.includes("proxy")) && (
        <div className="glass-panel rounded-xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            {localConfig.use_proxy && (
              <>
                ...
                {localConfig.proxy_mode === "random_delay" && (
                  <div className="space-y-4 p-4 rounded-lg bg-secondary/20 border border-border">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="delay_min" className="text-sm text-muted-foreground">Min Delay</Label>
                        <Input
                          id="delay_min"
                          type="number"
                          min={0}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="delay_max" className="text-sm text-muted-foreground">Max Delay</Label>
                        <Input
                          id="delay_max"
                          type="number"
                ...
                {localConfig.proxy_mode === "reorder" && (
                  <div className="space-y-4 p-4 rounded-lg bg-secondary/20 border border-border">
                    <Label htmlFor="reorder_window" className="text-foreground font-medium">Reorder Window Size</Label>
                    <Input
                      id="reorder_window"
                      type="number"
                      min={2}
      ...
      {(!showOnly || showOnly.includes("simulation")) && (
        <div className="glass-panel rounded-xl p-6">
          <div className="flex items-center gap-3 mb-6">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="simulation_timing" className="text-foreground">
                Simulation Duration (s)
              </Label>
              <Input
                id="simulation_timing"
                type="number"
                min={0}
                step={1}
              ...
              <p className="text-xs text-muted-foreground">
                Duration before auto-stop. Set to 0 for indefinite run.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Action Buttons Card */}
      {(!showOnly || showOnly.includes("actions")) && (
        <div className="glass-panel rounded-xl p-6">
